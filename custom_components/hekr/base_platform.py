...
from typing import Optional, TYPE_CHECKING, Dict, Any, Type, Sequence, Callable, Set, List
...
if TYPE_CHECKING:
    ...
    from .supported_protocols import _EntityConfig
...
def create_entities(entity_domain: str, entity_factory: Type['HekrEntity'],
                    ...
                    base_config: ConfigType, logger: logging.Logger = _LOGGER) -> Optional[List['HekrEntity']]:
    """
    ...
    :param logger: Output messages to given logger (default: this module's logger)
    """
...
async def base_async_setup_entry(entity_domain: str, entity_factory: HekrEntityType,
                                 ...
                                 logger: logging.Logger = _LOGGER) -> bool:
...
class HekrEntity(Entity):
    _entity_config: '_EntityConfig' = NotImplemented
    ...
    def __init__(self,
        ...
        self._entity_config = getattr(supported_protocol, ent_type)
        ...
        self._name = name_format.format(
            device_id=device_id,
            ent_type=ent_type,
            ent_name=self._entity_config.name,
    ...
    async def async_added_to_hass(self) -> None:
        ...
        self._logger.debug(
            "Added entity '%s' for device with ID '%s' to Home Assistant"
    ...
    async def async_will_remove_from_hass(self) -> None:
        ...
        self._logger.debug(
            "Will remove entity '%s' for device with ID '%s' from Home Assistant"
            % (self, self._device_id)
        )
    ...
    def handle_data_update(self, filtered_attributes: Dict[str, Any]) -> None:
        ...
        """
        state, attributes = self._entity_config.get_state_with_attributes(filtered_attributes)
    ...
    def _sync_execute_command(self, command: 'CommandCall'):
        ...
        self._logger.debug("Executing protocol command: %s")
    ...
    def icon(self) -> Optional[str]:
        ...
        return self._entity_config.get_icon(self._state)
    ...
    def unit_of_measurement(self) -> Optional[str]:
        return self._entity_config.unit_of_measurement
    ...
    def device_class(self) -> Optional[str]:
        ...
        return self._entity_config.device_class
